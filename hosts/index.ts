...
export const ALL_HOST_CONFIGS: HostConfig[] = [claude, codex, copilot, factory, kiro, opencode, slate, cursor, openclaw, hermes, gbrain];
...
export { claude, codex, copilot, factory, kiro, opencode, slate, cursor, openclaw, hermes, gbrain };
