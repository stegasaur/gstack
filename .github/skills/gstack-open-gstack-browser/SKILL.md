...
_EXT_PATH=""
_ROOT=$(git rev-parse --show-toplevel 2>/dev/null)
[ -n "$_ROOT" ] && [ -f "$_ROOT/.github/skills/gstack/extension/manifest.json" ] && _EXT_PATH="$_ROOT/.github/skills/gstack/extension"
[ -z "$_EXT_PATH" ] && [ -f "$HOME/.github/skills/gstack/extension/manifest.json" ] && _EXT_PATH="$HOME/.github/skills/gstack/extension"
