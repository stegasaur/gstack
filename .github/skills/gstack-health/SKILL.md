...
Read .github/copilot-instructions.md and look for a `## Health Stack` section. If found, parse the tools
...
A) Looks right -- persist to .github/copilot-instructions.md and continue
...
3. **Respect .github/copilot-instructions.md.** If `## Health Stack` is configured, use those exact commands. Do not second-guess.
