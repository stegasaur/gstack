...
Export learnings as markdown suitable for adding to .github/copilot-instructions.md or project documentation.
...
Present the formatted output to the user. Ask if they want to append it to .github/copilot-instructions.md
