...
2. **Read the entry points.** Identify and read:
   - README.md, ARCHITECTURE.md, CONTRIBUTING.md, .github/copilot-instructions.md / AGENTS.md
...
2. **Update entry-point files.** Add references to new docs in:
   ...
   - .github/copilot-instructions.md / AGENTS.md — add to project structure if relevant
