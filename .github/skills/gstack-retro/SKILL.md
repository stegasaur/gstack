...
[ -z "$DISCOVER_BIN" ] && [ -x .github/skills/gstack/bin/gstack-global-discover ] && DISCOVER_BIN=.github/skills/gstack/bin/gstack-global-discover
...
- Do not read .github/copilot-instructions.md or other docs — this skill is self-contained
