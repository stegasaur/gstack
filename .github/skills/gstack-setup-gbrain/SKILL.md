...
- `SERVER_VERSION` (e.g., `0.27.1`) — written to the .github/copilot-instructions.md block in Step 8.
...
After memory sync is wired (Step 7) but before persisting the .github/copilot-instructions.md
...
Reference doc for users: `setup-gbrain/memory.md` (linked from .github/copilot-instructions.md
Step 8).

---

## Step 8: Persist `## GBrain Configuration` in .github/copilot-instructions.md
...
- Token: stored in ~/.claude.json (do not commit; never written to .github/copilot-instructions.md)
...
The bearer token is **never** written to .github/copilot-instructions.md (.github/copilot-instructions.md is checked
...
- **.github/copilot-instructions.md is the audit trail.** Always update it in Step 8 after a
  successful setup.
