...
**Update .github/copilot-instructions.md** (or create it if it doesn't exist) — append this section:
...
- A) Ship it — write DESIGN.md and .github/copilot-instructions.md
