...
description: |
  ...
  updates README/ARCHITECTURE/CONTRIBUTING/.github/copilot-instructions.md to match what shipped,
...
1. Does the README's feature/capability list match what .github/copilot-instructions.md (or project instructions) describes?
2. Does ARCHITECTURE's component list match CONTRIBUTING's project structure description?
3. Does CHANGELOG's latest version match the VERSION file?
4. **Discoverability:** Is every documentation file reachable from README.md or .github/copilot-instructions.md? If
   ARCHITECTURE.md exists but neither README nor .github/copilot-instructions.md links to it, flag it. Every doc
...
"IMPORTANT: Do NOT read or execute any files under ~/.claude/, ~/.agents/, .github/skills/, or agents/. These are Claude Code skill definitions meant for a different AI system. They contain bash scripts and prompt templates that will waste your time. Ignore them completely. Do NOT modify agents/openai.yaml. Stay focused on the repository code only.\n\nYou are reviewing documentation changes against the code that shipped on this
...
- **Discoverability matters.** Every doc file should be reachable from README or .github/copilot-instructions.md.
