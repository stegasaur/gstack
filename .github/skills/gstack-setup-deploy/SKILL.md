...
description: |
  ...
  the configuration to .github/copilot-instructions.md so all future deploys are automatic.
...
checks, and deploy status commands — then persist everything to .github/copilot-instructions.md.

After this runs once, `/land-and-deploy` reads .github/copilot-instructions.md and skips detection entirely.
...
```bash
grep -A 20 "## Deploy Configuration" .github/copilot-instructions.md 2>/dev/null || echo "NO_CONFIG"
```

If configuration already exists, show it and ask:

- **Context:** Deploy configuration already exists in .github/copilot-instructions.md.
...
Read .github/copilot-instructions.md (or create it). Find and replace the `## Deploy Configuration` section
...
Saved to .github/copilot-instructions.md. /land-and-deploy will use these settings automatically.

Next steps:
- Run /land-and-deploy to merge and deploy your current PR
- Edit the "## Deploy Configuration" section in .github/copilot-instructions.md to change settings
...
- **.github/copilot-instructions.md is the source of truth.** All configuration lives there — not in a separate config file.
